...
* Dataset pre-processing
  * Get depth maps using Depth Anything V2
    ```bash
    python utils/run_depth_anything_v2.py data/Family/images
    ```

  * Get depth scales and offsets
    ```bash
    python utils/get_depth_scales.py data/Family
    ```
    
  With above operations, the structure of `data/Family` should be like this:
  ```bash
  ├── data/Family
